    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white border-gray-200 p-0 opacity-50 hover:opacity-100 hover:bg-gray-100"
        ),
        ...
        day_outside:
          "day-outside text-gray-500 aria-selected:bg-gray-100/50 aria-selected:text-gray-500",
