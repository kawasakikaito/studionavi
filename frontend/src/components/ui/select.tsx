...
const selectTriggerVariants = cva(
  [
    "inline-flex items-center justify-between whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50",
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline: [
          "border border-input bg-background h-10 px-4 py-2 w-full",
          "hover:bg-accent",
          "focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2",
          "data-[state=open]:bg-accent data-[state=open]:ring-0",
        ].join(" "),
      },
    },
    defaultVariants: {
